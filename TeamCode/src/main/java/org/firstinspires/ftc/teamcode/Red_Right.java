...
@Autonomous(name = "RED: Right Side", group = "Automonous")
...
// Calls up IMU (Inertial Measruement Unit within REV Hub)
    ...
    public void runOpMode() {
        ...
        if (x == 1) {
            ...
            gyroDrive(.4, 11, 47);  //approach high junction
...
//Drop the Cone
            ...
            sleep(1500);
            gyroDrive(.2, -18,47); // back into end position
...
//Drop the Cone
            ...
            robot.servorelease.setPosition(.35);
            sleep(1500);
            gyroDrive(.2, -15,47); // back into end position
            lift(.5, -25); // lower lift and hold position
            gyroTurn(.5, 0);
            gyroDrive(.5, 10, 0);
        ...
        if (x == 3) {
            ...
            lift(.5, 28); // raise lift and hold position
            gyroDrive(.3, 42, 0);  //Approach thrid tile in
            gyroTurn(.5, 46); //turn toward high junction
            gyroDrive(.4, 11, 46);  //approach high junction
...
//Drop the Cone
            ...
            robot.servorelease.setPosition(.35);
            sleep(1500);
            gyroDrive(.2, -19,46); // back into end position
            lift(.5, -25); // lower lift and hold position
            gyroTurn(.5, 0);
            gyroStrafe(.5, 42, 0);
            gyroDrive(.5, 10, 0);
