...
@Autonomous(name = "RED: Right Side EXTRA", group = "Automonous")

public class Red_Right_Extra_Cones extends LinearOpMode{
...
//Go To Cone Stack
            ...
            gyroDrive(.3, 31,-88); // back into end position
            sleep(500);
...
//Sleeve and Drop the Cone
            ...
            robot.servorelease.setPosition(.35);
            sleep(500);
            gyroDrive(.4, -10.5,-229); // back away from terminal
...
// *****************************************************************************
//Sleeve and Drop the Cone
            lift(.1, -7); // lower lift and hold position
            robot.servorelease.setPosition(.35);
            sleep(500);
            gyroDrive(.4, -10.5,-229); // back away from terminal
            robot.servorelease.setPosition(.5);
